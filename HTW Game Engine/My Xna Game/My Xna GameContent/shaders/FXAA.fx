///////////////////////////////////////////////////////////////////////////
// Code adapted from http://mtnphil.wordpress.com/2012/10/15/fxaa-in-xna/
...
// Warning: Andrew doesn't have the slightest clue what is going on in this shader header file being included, it just works.
// Andrew does know that it is several thousand lines of intense math stuff.
// The algorithm is super optimized ( published by NVIDIA )
